<h3>
    <a href="<?php echo $_SESSION['home'] ?>admin" title="Inicio">Inicio</a> <span>| bosques</span>
</h3>
<div class="row">
    <!--Nuevo-->
        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/bosques/crear" ?>" title="Añadir nueva bosque">
        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/bosques/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/bosques/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/bosques/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Borrar bosque<i class="material-icons right">close</i></span>
                    <p>
                        ¿Está seguro de que quiere borrar la bosque<strong><?php echo $row->titulo ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/bosques/borrar/".$row->id ?>" title="Borrar">
